...
# Finetune.
python dataset_shift_exp.py whobin75 data/who/whobin_75 whobin75_wd001_ft_soft_b5_ep4000 --activation=soft --beta=5 --variations=10 --lr=0.5 --epochs=4000 --finetune_epochs=1000 --weight_decay=0.001
python dataset_shift_exp.py whobin75 data/who/whobin_75 whobin75_wd001_ft_soft_b10_ep4000 --activation=soft --beta=10 --variations=10 --lr=0.5 --epochs=4000 --finetune_epochs=1000 --weight_decay=0.001
python dataset_shift_exp.py whobin75 data/who/whobin_75 whobin75_wd001_ft_relu_ep4000 --variations=10 --lr=0.5 --epochs=4000 --finetune_epochs=1000 --weight_decay=0.001
python dataset_shift_exp.py whobin75 data/who/whobin_75 whobin75_wd01_ft_relu_ep4000 --variations=10 --lr=0.5 --epochs=4000 --finetune_epochs=1000 --weight_decay=0.01
python dataset_shift_exp.py whobin75 data/who/whobin_75 whobin75_wd0_ft_relu_ep4000 --variations=10 --lr=0.5 --epochs=4000 --finetune_epochs=1000 --weight_decay=0.0
